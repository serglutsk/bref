...
$(document).ready(function() {
    ...
    var	subMenu = $(".sub-menu"),
        subMenuHeader = $(".sub-header a");

    $('body').addClass("js");

    animateEffectOn = function(elem,list) {
        elem.animate({
            "font-size": 1+"em",
            "min-width":140,
    ...
    animateEffectOut = function(elem,list) {
        list.animate({
            "font-size": 0,
            "border-width": 0,
            "height": 0
    ...
    $(".navigation .menu-item").hoverIntent(function() {
        var subHeader = $(this).find(".sub-header a"),
            subElements = $(this).find(".sub-menu .sub-elements a");
        if ($(this).find('.sub-menu').length) {
            $(this).find('.sub-menu').show();
            $(this).addClass('active-sub-menu');
            animateEffectOn(subHeader,subElements);
        }
        ...
        animateEffectOut(subHeader,subElements)
    })
    // Notification
    $(".user-name").click(function() {
        $(".preferences-popup").slideToggle();
    })

    $('.navigation li').on('click', function(){
        $('.navigation li').removeClass('active-item');
