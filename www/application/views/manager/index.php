...
<header class="content-header">
    ...
    <ul class="project-status">
        <li class="first"><a href="" class="active-item" id="all"><?=__('Все')?></a></li>
        <li><a href="" id="new"><?=__('Новые')?></a></li>
        <li><a href="" id="active"><?=__('В процессе')?></a></li>
        <li><a href="" id="pending"><?=__('Ждут ответа')?></a></li>
        <li class="last"><a href="" id="complete"><?=__('Утвержденные')?></a></li>
    </ul>
    ...
    <?php foreach($briefs as $status => $brief):?>
        ...
        <section class="<?=$status?>">
            ...
            <ul class="show-project">
                ...
                <li data-value="all" class="button"><?=__('Все')?></li>
            </ul>
            ...
            <?php foreach($brief as $record):
               $user= $record->user->find('username')?>
                ...
                <ul class="site-status">
                    ...
                    <li class="project-type"><?=__($user->username);?></li>
                        ...
                        <ul class="informatione">
                            ...
                            <ul class="detail-information">
                                ...
                                <ul>
                                    ...
                                    <li><?php foreach( (array) unserialize($record->devices) as $device) { echo __($device).' '; } ?></li>
                                </ul>
                                <ul>
                                    <li><?=__('Стиль')?></li>
                                ...
                                <ul class="show-details">
                                    <li><?=__('Нравится:')?></li>
                                    <li><span class="list-item"></span> <span class="show-detail"><?=__('Показать')?></span></li>
                                    <div class="show-detail"><?php foreach( (array) unserialize($record->like_sites) as $site) { echo $site.'<br/>'; } ?></div>
                                </ul>
                                <ul class="show-details">
                                    <li><?=__('Не нравится')?></li>
                                    <li><span class="list-item"></span> <span class="show-detail"><?=__('Показать')?></span></li>
                                    <div class="show-detail"><?php foreach( (array) unserialize($record->dislike_sites) as $site) { echo $site.'<br>'; } ?></div>
                                </ul>
                                <ul>
                                ...
                                <ul>
                                    ...
                                    <li><?php foreach( (array) unserialize($record->project->target_audience) as $audience) { echo $audience.'<br>'; } ?></li>
                                </ul>
                                <ul>
                                    <li><?=__('Audience ages')?></li>
                                    <li><?php foreach( (array) unserialize($record->project->audience_ages) as $age) { echo $age.'<br>'; } ?></li>
                                </ul>
                                <ul>
                                    <li><?=__('Audience gender')?></li>
                                    <li><?php foreach( (array) unserialize($record->project->audience_genders) as $gender) { echo $gender.'<br>'; } ?></li>
                                </ul>
                                <ul>
                                    <li><?=__('Company location')?></li>
                                    <li><?php foreach( (array) unserialize($record->project->audience_locations) as $location) { echo $location.'<br>'; } ?></li>
                                </ul>
                                <ul class="show-details">
                                ...
                                <ul>
                                    ...
                                    <li><?php foreach( (array) unserialize($record->project->site_types) as $type) { echo $type.'<br>'; } ?></li>
                                </ul>
                                <ul class="show-details">
                                    <li><?=__('Меню')?></li>
                                    <li><span class="list-item"></span> <span class="show-detail"><?=__('Показать')?></span></li>
